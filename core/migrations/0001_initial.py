# Generated by Django 3.2.9 on 2022-03-08 19:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ad_kind', models.CharField(choices=[('OF', 'Offering'), ('RQ', 'Requesting')], default='OF', max_length=2, verbose_name='Annonstyp')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('interval', models.CharField(choices=[('WK', 'Veckovis'), ('DL', 'Dagligen')], default='WK', max_length=2, verbose_name='Intervall')),
                ('ad_type', models.CharField(choices=[('OF', 'Erbjudes'), ('RQ', 'Sökes')], default='OF', max_length=2, verbose_name='Annonstyp')),
                ...
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='news_email', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
